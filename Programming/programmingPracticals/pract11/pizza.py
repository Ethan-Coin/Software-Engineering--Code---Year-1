...
class Order:
    ...
    def updateSize(self, pizzaIndex, size):
        if pizzaIndex < len(self.pizzas):
            self.pizzas[pizzaIndex].setSize(size)

    def addTopping(self, pizzaIndex, topping):
        if pizzaIndex < len(self.pizzas):
            self.pizzas[pizzaIndex].addTopping(topping)

    def removeTopping(self, pizzaIndex, topping):
        if pizzaIndex < len(self.pizzas):
